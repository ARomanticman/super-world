...
public class JarTotal {
    ...
    //jar包存放的仓库位置
    public static String jarPath = "C:\\code\\super-world\\src\\main\\java\\cn\\hangzhou\\liuxx\\superworld\\jars\\eva";
    //存放所有的jar的包路径和名称
    ...
    public static int runJarTotal() {
        try {
            File filetxtPath = new File("C:\\Users\\33413\\OneDrive\\Desktop\\jarFileCount.txt");//输出要统计的文件信息
